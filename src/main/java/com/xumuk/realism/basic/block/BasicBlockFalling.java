...
{
	public BasicBlockFalling(Material materialIn, String name, CreativeTabs tab) {
	...
	public void checkFallableDown(World world, BlockPos pos)
	{	
	...
	public void checkFallableSouth(World world, BlockPos pos)
	{
		IBlockState state = world.getBlockState(pos);
	...
	public void checkFallableNorth(World world, BlockPos pos)
	{
		IBlockState state = world.getBlockState(pos);
	...
	public void checkFallableWest(World world, BlockPos pos)
	{
		IBlockState state = world.getBlockState(pos);
	...
	public void checkFallableEast(World world, BlockPos pos)
	{
		IBlockState state = world.getBlockState(pos);
